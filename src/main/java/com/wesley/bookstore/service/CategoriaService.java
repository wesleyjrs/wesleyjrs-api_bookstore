...
public class CategoriaService {
	...
	public void delete(Integer id) {
		...
		try {
			...
			throw new com.wesley.bookstore.service.exceptions.DataIntegrityViolationException(
					"Categoria não pode ser deletada! Contém livros associados a essa categoria!");
		}
